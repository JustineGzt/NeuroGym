...
export const MoodSelector: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white rounded-3xl p-5 shadow-sm border border-gray-100 mb-5">
          ...
          return (
            <button 
              ...
              className={`flex flex-col items-center gap-1.5 p-2 rounded-2xl transition-all ${
                isSelected ? 'bg-[#f4f3ef] scale-105 font-bold text-[#1d3557]' : 'opacity-60 hover:opacity-100 text-gray-500'
              }`}
            >
